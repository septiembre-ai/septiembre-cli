...
// Brand presentation constants. brandGreen is the Septiembre brand color
...
// bannerArt is the "septiembre" wordmark (figlet "small") shown in interactive
// help. Trailing whitespace is intentionally omitted so the block stays tight.
const bannerArt = ` ___ ___ _ __| |_(_)___ _ __ | |__ _ _ ___
(_-</ -_) '_ \  _| / -_) '  \| '_ \ '_/ -_)
/__/\___| .__/\__|_\___|_|_|_|_.__/_| \___|
        |_|`

// bannerTagline sits under the wordmark.
const bannerTagline = "  the Septiembre cloud platform"
