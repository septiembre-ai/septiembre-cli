...
func TestOpenCommand_PerOS(t *testing.T) {
	const url = "https://auth.septiembre.ai/oauth2/authorize?state=abc"
...
func TestBrowserOpener_RecordsURL(t *testing.T) {
	...
	const authorizeURL = "https://auth.septiembre.ai/oauth2/authorize?state=xyz"
...
func TestBrowserOpener_FailurePathReturnsErrorNoPanic(t *testing.T) {
	...
	err := opener("https://auth.septiembre.ai/oauth2/authorize?state=xyz")
	if err == nil {
