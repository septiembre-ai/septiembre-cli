...
func TestCreateApp_Success(t *testing.T) {
	...
	c, _ := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/api/v1/orgs/org-1/apps" {
			t.Errorf("path = %q, want /api/v1/orgs/org-1/apps", r.URL.Path)
		}
...
func TestDeleteApp_Success(t *testing.T) {
	...
	c, _ := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/api/v1/orgs/org-1/apps/app-1" {
			t.Errorf("path = %q, want /api/v1/orgs/org-1/apps/app-1", r.URL.Path)
		}
		w.Header().Set("Content-Type", "application/json")
