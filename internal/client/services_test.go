...
func TestCreateKVSTable_SendsBody(t *testing.T) {
	...
	c, _ := newTestClient(t, func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/api/v1/orgs/org-1/apps/app-1/services/kvs/tables" {
			t.Errorf("path = %q, want /api/v1/orgs/org-1/apps/app-1/services/kvs/tables", r.URL.Path)
		}
		...
		_ = json.NewEncoder(w).Encode(client.KVSTableResponse{
			Table: &client.KVSTable{ID: "table-1", Name: "sessions", Status: "active", KVSURL: "https://kvs.septiembre.ai", MinuteLimit: 300},
