...
func (c *Client) CreateApp(ctx context.Context, orgID string, req CreateAppRequest) (*App, error) {
	var resp App
	if err := c.post(ctx, "/api/v1/orgs/"+orgID+"/apps", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (c *Client) DeleteApp(ctx context.Context, orgID, appID string) (*DeleteAppResponse, error) {
	...
	if err := c.deleteInto(ctx, "/api/v1/orgs/"+orgID+"/apps/"+appID, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}

// App represents a Septiembre application.
type App struct {
	ID             string    `json:"id"`
...
// using the flat GET /api/v1/apps route. Useful for resolving an app-id to its org.
...
func (c *Client) ListApps(ctx context.Context, orgID string) ([]App, error) {
	var resp []App
	if err := c.get(ctx, "/api/v1/orgs/"+orgID+"/apps", &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (c *Client) GetApp(ctx context.Context, orgID, appID string) (*App, error) {
	var resp App
	if err := c.get(ctx, "/api/v1/orgs/"+orgID+"/apps/"+appID, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
