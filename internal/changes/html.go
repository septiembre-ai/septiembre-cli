...
func htmlGraphData(graph Graph) htmlGraph {
	...
	return htmlGraph{Base: graph.Base, Nodes: viewNodes, Edges: edges, Diffs: diffs, Release: graph.Release, Changelog: graph.Changelog}
}
